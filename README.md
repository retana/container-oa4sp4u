...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-oa4sp4u.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-oa4sp4u.containers.anotherwebservice.com/
...
```
git clone git@github.com:retana/container-oa4sp4u.git
cd container-oa4sp4u
```
...
```
docker attach container-oa4sp4u
```
